...
async def main():
    ...
    print("=" * 60)
    print("💎 CashApp Pro Dashboard Manager")
    print("=" * 60)
    print(f"🤖 Бот запущен")
    print(f"📁 Папка с сайтами: sites/")
    print(f"🖼️ Стандартный логотип: {site_manager.default_logo_path}")
    print(f"📊 Загружено дашбордов: {len(site_manager.sites)}")
    print("=" * 60)
    print("\n✨ <b>Особенности нового дизайна:</b>")
    print("• Гармоничный черно-зеленый CashApp стиль")
    print("• Профессиональная типографика")
    print("• Анимации и эффекты")
    print("• Полная адаптивность (ПК + телефон)")
    print("• Автоматический логотип CashApp")
    print("• Система Ограна для верификации")
    print("• Ограничительный экран с прогресс-баром")
    print("• Управление через Telegram бота")
    print("=" * 60)
